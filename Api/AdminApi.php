...
class AdminApi extends \Zikula_AbstractApi
{
    ...
    public function update($args)
    {
        ...
        if (isset($args['prop_weight'])) {
            if ($args['prop_weight'] == 0) {
                ...
                $property = $this->entityManager->getRepository('Zikula\ProfileModule\Entity\PropertyEntity')->findOneBy(array('prop_weight' => $args['prop_weight']));
        ...
        $property = $this->entityManager->getRepository('Zikula\ProfileModule\Entity\PropertyEntity')->find($args['dudid']);
        $property->merge($obj);
        $this->entityManager->flush();
    ...
    public function delete($args)
    {
        ...
        // delete the property
        $qb = $this->entityManager->createQueryBuilder();
        $qb->delete('Zikula\ProfileModule\Entity\PropertyEntity', 'p')
            ->where('p.prop_id = :id')
    ...
    public function activate($args)
    {
        ...
        $prop = $this->entityManager->find('Zikula\ProfileModule\Entity\PropertyEntity', $args['dudid']);
    ...
    public function deactivate($args)
    {
        ...
        $qb = $this->entityManager->createQueryBuilder();
        $qb->update('Zikula\ProfileModule\Entity\PropertyEntity', 'p')
